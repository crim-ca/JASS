...
class TestStorageManager(unittest.TestCase):
    ...
    def test_createMongoDocument(self):
        ...
        self.assertTrue(id != "yolo", "Created id :%s should be different from the id in the document, since we ignore it." % (id))
    ...
    def test_updateMongoDocument(self):
        ...
        self.assertEqual(gotDocument['@context'], context, "The initial document should have been updated: %s vs %s" % (gotDocument['@context'], context))
    ...
    def test_deleteMongoDocument(self):
        ...
        self.assertFalse(self.d.deleteMongoDocument("yolo"),"Such a document should not exits, since we are deleting it a second time")
        id = self.d.createMongoDocument(self.l('{"@context":"testing_context"}'))
        self.assertTrue(id != "", "Object id must be not null %s" % (id))
